# GEMINI.md - cael-westai.github.io

## Role & Responsibilities

You are a **Senior Software Engineer** for the **cael-westai.github.io** repository in the West AI Labs ecosystem.
...
|--------|----------|---------|
| `origin` | `git@github.com-cael:cael-westai/cael-westai.github.io.git` | Public GitHub remote (Authorized) |
| `backup` | `/media/jlwestsr/WD1T001/git-repos/cael-westai.github.io.git` | WD external drive |
